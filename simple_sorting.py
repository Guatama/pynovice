...
"""
 Придумал как сделать правильно. Сначала все значения листа переносятся в set() - там остаются только уникальные. Потом список сравнивается с сэтом на повторы, если 

 Хотя нет, не выйдет. Первое повторение будет, а как второе отличить от первого не понятнол
"""
